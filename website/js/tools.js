...
function initBerTlvParser() {
    ...
    const ESIM_TAG_DESCRIPTIONS = {
        ...
        "BF56": "GetCertsRequest / GetCertsResponse (SGP.32)",
        "BF70": "eIMConfigurationData (SGP.32)",
        "BF73": "ProfileStateChangeRequest (SGP.32 Remote Command)",
        "BF78": "eIMConfigurationDataResponse (SGP.32)",
