...
public class LpaDownloadService {
  ...
  public DownloadResponse downloadProfile(String activationCode) {
    return downloadProfile(activationCode, "LPA");
  }

  public DownloadResponse downloadProfile(String activationCode, String simType) {
    log.info(
        "LPA Simulator initiating profile download: {} for simType: {}", activationCode, simType);
    ...
    try {
      ...
      localProfile.setSimType(simType);
