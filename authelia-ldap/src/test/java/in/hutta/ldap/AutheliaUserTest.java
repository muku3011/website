  ...
  public void testUserLifecycle() {
    ...
    ResponseEntity<Map> createResponse =
        restTemplate.postForEntity(
            "/gsma/rsp/v2/authelia/users?username=testuser", createReq, Map.class);
    assertThat(createResponse.getStatusCode()).isEqualTo(HttpStatus.CREATED);

    // Fetch again and verify
    ResponseEntity<AutheliaUserController.UserResponse[]> afterCreateResponse =
        restTemplate.getForEntity(
            "/gsma/rsp/v2/authelia/users", AutheliaUserController.UserResponse[].class);
    AutheliaUserController.UserResponse[] users =
        Objects.requireNonNull(afterCreateResponse.getBody());
    ...
    restTemplate.put("/gsma/rsp/v2/authelia/users/testuser", updateReq);

    // Fetch again
    ResponseEntity<AutheliaUserController.UserResponse[]> afterUpdateResponse =
        restTemplate.getForEntity(
            "/gsma/rsp/v2/authelia/users", AutheliaUserController.UserResponse[].class);
    AutheliaUserController.UserResponse[] updatedUsers =
        Objects.requireNonNull(afterUpdateResponse.getBody());
    ...
    // Verify deleted
    ResponseEntity<AutheliaUserController.UserResponse[]> afterDeleteResponse =
        restTemplate.getForEntity(
            "/gsma/rsp/v2/authelia/users", AutheliaUserController.UserResponse[].class);
    AutheliaUserController.UserResponse[] finalUsers =
        Objects.requireNonNull(afterDeleteResponse.getBody());
