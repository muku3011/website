...
public class Es9PlusController {
  ...
  public ResponseEntity<?> initiateAuthentication(
    ...
    Optional<SessionContext> sessionOpt =
        profileService.initiateAuthentication(
      ...
      return ResponseEntity.status(500)
          .body(
              java.util.Map.of(
                  ...
                  "message",
                  "Error: No profiles available for provisioning"));
    }
  }
  ...
  public ResponseEntity<?> authenticateClient(
    ...
    boolean isAuthenticated =
        profileService.authenticateClient(
  ...
  public ResponseEntity<?> getBoundProfilePackage(
    ...
    Optional<String> bppOpt =
        profileService.getBoundProfilePackage(
    ...
    if (bppOpt.isPresent()) {
      ...
      return ResponseEntity.status(400)
          .body(
              java.util.Map.of(
                  "error",
                  "Bound profile package generation failed",
                  "message",
                  "Error: Failed to generate Bound Profile Package"));
    }
  }
  ...
  public ResponseEntity<?> handleNotification(
    ...
    if (success) {
      ...
      return ResponseEntity.badRequest()
          .body(java.util.Map.of("status", "Failed", "message", "Error processing notification"));
    }
  }
}
